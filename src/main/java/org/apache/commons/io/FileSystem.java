...
public enum FileSystem {
     ...
     * (which occurs only if the program has cleared the "os.name" system property).
     * </p>
     */
     ...
     * @return true if matches, or false if not or can't determine
     */
    private static boolean isOsNameMatch(final @Nullable String osName, final String osNamePrefix) {
        if (osName == null) {
            return false;
        }
     ...
     */
    public boolean isLegalFileName(final @Nullable CharSequence candidate) {
