...
public class FilterCollectionWriter extends Writer {
     ...
     */
    protected final Collection<? extends @Nullable Writer> writers;
     ...
     */
    protected FilterCollectionWriter(final @Nullable Collection<? extends @Nullable Writer> writers) {
     ...
     * @param writers Writers to provide the underlying targets.
     */
    protected FilterCollectionWriter(final Writer @Nullable ... writers) {
