...
public final class PathUtils {
    ...
    private static class RelativeSortedPaths {
        ...
        // final @Nullable List<Path> relativeDirList1; // might need later?
        // final @Nullable List<Path> relativeDirList2; // might need later?
        final @Nullable List<Path> relativeFileList1;
        final @Nullable List<Path> relativeFileList2;
    ...
    public static boolean directoryAndFileContentEquals(final Path path1, final Path path2,
        ...
        @SuppressWarnings("nullness") // if both files exist and equals is true, the field is set
        final @NonNull List<Path> fileList1 = relativeSortedPaths.relativeFileList1;
        @SuppressWarnings("nullness") // if both files exist and equals is true, the field is set
        final @NonNull List<Path> fileList2 = relativeSortedPaths.relativeFileList2;
    ...
    static List<Path> relativize(final Collection<Path> collection, final Path parent, final boolean sort,
        final @Nullable Comparator<? super Path> comparator) {
     ...
     * @return a new Set.
     */
    static Set<FileVisitOption> toFileVisitOptionSet(final FileVisitOption @Nullable ... fileVisitOptions) {
